...
export function SocialProof({ reviews, rating, count }: SocialProofProps) {
    return (
        <View className="flex-row items-center justify-center bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-sm border border-gray-100 self-center mx-auto mb-6">
            ...
            <View>
                <View className="flex-row items-center">
                    <Text className="font-bold text-charcoal mr-1">{rating}</Text>
