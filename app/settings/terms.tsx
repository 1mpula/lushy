    ...
    return (
        <View className="flex-1" style={{ backgroundColor: theme === 'dark' ? '#121212' : '#FFFFFF' }}>
            ...
            <ScrollView className="flex-1 p-6" contentContainerStyle={{ paddingBottom: 60 }}>
                {/* Terms of Service */}
                <Text className="text-2xl font-bold font-heading text-foreground mb-4">Terms of Service</Text>
                ...
                <Text className="text-lg font-bold text-foreground mb-2 mt-4">1. Acceptance of Terms</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">2. User Accounts</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">3. Booking Services</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">4. Cancellation Policy</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">5. Payments</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">6. Prohibited Conduct</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                {/* Divider */}
                <View className="h-px my-8" style={{ backgroundColor: theme === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.08)' }} />

                {/* Privacy Policy */}
                <Text className="text-2xl font-bold font-heading text-foreground mb-4">Privacy Policy</Text>
                <Text className="text-sm text-mediumGray mb-2">Last updated: January 2026</Text>
                ...
                <Text className="text-lg font-bold text-foreground mb-2 mt-4">Information We Collect</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">How We Use Your Information</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">Information Sharing</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">Data Security</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                    We implement industry-standard security measures to protect your personal information. However, no method of transmission over the internet is 100% secure, and we cannot guarantee absolute security.
                </Text>

                <Text className="text-lg font-bold text-foreground mb-2">Your Rights</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                ...
                <Text className="text-lg font-bold text-foreground mb-2">Contact Us</Text>
                <Text className="text-base text-foreground leading-relaxed mb-4">
                    If you have any questions about these Terms or our Privacy Policy, please contact us at privacy@lushy.app.
                </Text>

                <View className="p-4 rounded-xl mt-4" style={{ backgroundColor: theme === 'dark' ? '#1A1A1A' : '#F9FBFC' }}>
                    <Text className="text-sm text-center" style={{ color: theme === 'dark' ? '#A0A0A0' : '#8E8E93' }}>
